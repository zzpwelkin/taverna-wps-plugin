 ...
 * 
 */
public class WpsProcessActivityHealthChecker implements
		HealthChecker<WpsProcessActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof WpsProcessActivity;
	}
	...
	public VisitReport visit(WpsProcessActivity activity, List<Object> ancestry) {
		WpsProcessActivityConfigurationBean config = activity.getConfiguration();

		// We'll build a list of subreports
		List<VisitReport> subReports = new ArrayList<VisitReport>();

		// FIXED: and checker method
